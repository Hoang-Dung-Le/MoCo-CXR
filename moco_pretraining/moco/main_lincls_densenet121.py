...
parser.add_argument('-b', '--batch-size', default=32, type=int,
                    ...
                    help='mini-batch size (default: 256), this is the total '
                         ...
                         'using Data Parafcllel or Distributed Data Parallel')
...
parser.add_argument('-p', '--print-freq', default=100, type=int,
                    metavar='N', help='pfcrint frequency (default: 10)')
...
# python main_lincls.py   -a resnet50   --lr 30.0   --batch-size 128  --resume 'model_best_siim_acr_pneumothorax.pth.tar' -e  --dist-url 'tcp://localhost:10001' --multiprocessing-distributed --world-size 1 --rank 0  'siim-acr-pneumothorax'
# python main_lincls.py   -a resnet50   --lr 30.0   --batch-size 128  --pretrained 'model_best_siim_acr_pneumothorax.pth.tar' -e  --dist-url 'tcp://localhost:10001' --multiprocessing-distributed --world-size 1 --rank 0 --train_data ../../data/siim-acr-pneumothorax/train_set/  --val_data ../../data/siim-acr-pneumothorax/test_set/  --test_data ../../data/siim-acr-pneumothorax/test_set/ --binary
# python main_lincls.py -a resnet50 --lr 30.0 --batch-size 32  --pretrained checkpoint_0032_ResNet50.pth.tar  --dist-url 'tcp://localhost:10001' --multiprocessing-distributed --semi-supervised  --world-size 1 --rank 0  --train_data ../../data/chest_xray_ZhangLabData/train  --val_data ../../data/chest_xray_ZhangLabData/test  --test_data ../../data/chest_xray_ZhangLabData/test --from-imagenet --exp-name moco_v1_lincls_resnet50_ZhangLabData --binary >> result_resnet50_ZhangLabData_training.txt
# python main_lincls.py   -a resnet50   --lr 30.0   --batch-size 128  --resume ./ketqua/model_best_covid19_train_full.pth.tar -e  --dist-url 'tcp://localhost:10001' --multiprocessing-distributed --world-size 1 --rank 0 --train_data ../../data/covid19_folder/train_set/  --val_data ../../data/covid19_folder/valid_set/  --test_data ../../data/covid19_folder/test_set/
# python main_lincls.py   -a resnet50   --lr 30.0   --batch-size 64  --resume ./ketqua/model_best_covid19_100_LINEAR.pth.tar -e  --dist-url 'tcp://localhost:10001' --multiprocessing-distributed --world-size 1 --rank 0 --train_data ../../data/covid19_folder/train_set/  --val_data ../../data/covid19_folder/valid_set/  --test_data ../../data/covid19_folder/test_set/
# python main_lincls_densenet121.py -a densenet121 --lr 30.0 --batch-size 32  --pretrained densenet121checkpoint_0020.pth.tar  --dist-url 'tcp://localhost:10001' --multiprocessing-distributed  --world-size 1 --rank 0  --train_data ../../data/covid19_folder_new/train_set/  --val_data ../../data/covid19_folder_new/valid_set/  --test_data ../../data/covid19_folder_new/test_set/ --exp-name densenet121_covid_new_linear >> densenet121_covid_new_linear.txt
# python main_lincls_densenet121.py -a densenet121 --lr 30.0 --batch-size 32  --pretrained densenet121checkpoint_0020.pth.tar  --dist-url 'tcp://localhost:10001' --multiprocessing-distributed  --world-size 1 --rank 0  --train_data ../../data/5classes_25_Apr/train_set/  --val_data ../../data/5classes_25_Apr/valid_set/  --test_data ../../data/5classes_25_Apr/test_set/ --exp-name densenet121_5Class_SSL >> ./Result_26_April/5class_SSL_densenet121_linear.txt
# Evaluation python main_lincls_densenet121.py -a densenet121 --lr 30.0 --batch-size 32 --resume ./Result_26_April/5class_SSL_densenet121_linearmodel_best.pth.tar -e  --dist-url 'tcp://localhost:10001' --multiprocessing-distributed  --world-size 1 --rank 0  --train_data ../../data/5classes_25_Apr/train_set/  --val_data ../../data/5classes_25_Apr/valid_set/  --test_data ../../data/5classes_25_Apr/test_set/ --exp-name lincls_resnet50_covid_26Apr
# python main_lincls_mobilenetv2.py -a mobilenet_v2 --lr 30.0 --batch-size 32 --resume ./Result_26_April/5class_ImageNet_Mobile_linearmodel_best.pth.tar -e  --dist-url 'tcp://localhost:10001' --multiprocessing-distributed  --world-size 1 --rank 0  --train_data ../../data/5classes_25_Apr/train_set/  --val_data ../../data/5classes_25_Apr/valid_set/  --test_data ../../data/5classes_25_Apr/test_set/ --exp-name lincls_mobilev2_covid_26Apr
# Training python main_lincls_mobilenetv2.py -a mobilenet_v2 --lr 30.0 --batch-size 32  --pretrained mobilenet_v2_checkpoint_0020.pth.tar  --dist-url 'tcp://localhost:10001' --multiprocessing-distributed  --world-size 1 --rank 0  --train_data ../../data/5classes_25_Apr/train_set/  --val_data ../../data/5classes_25_Apr/valid_set/  --test_data ../../data/5classes_25_Apr/test_set/ --exp-name mobilenetv2_5Class_SSL >> ./Result_26_April/5class_SSL_mobilev2_linear.txt